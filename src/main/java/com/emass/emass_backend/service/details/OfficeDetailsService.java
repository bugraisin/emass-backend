...
public class OfficeDetailsService {
    ...
    public List<ListingDetailResponse> search(OfficeSearchRequest request) {
        return null;
...
//                null,
//                null,
//                new ListingDetailResponse.OfficeDetailsResponse(
//                        details.getSubtype(),
...
//                        details.getMeetingRoom(),
//                        details.getArchive(),
//                        details.getLibrary(),
//                        details.getServerRoom(),
//                        details.getAccessControl(),
//                        details.getFiberInternet(),
//                        details.getSoundproof()
//                ),
//                null, null, null
//        )).toList();
    }
